...
namespace Shlashurai.States
{
	public class ThirdPersonMovementStateLogic : StateLogic, IOnUpdateLogic, IOnFixUpdateLogic
	{
		...
		private readonly Vector3 vectorZero = Vector3.zero;
		private readonly Vector3 vectorForward = Vector3.forward;
		public void OnUpdate(float deltaTime, float timeScale)
		{
			...
			m_targetDirection = m_rotation * vectorForward;
		}

		public void OnFixUpdate(float deltaTime, float timeScale)
		{
			newPosition = m_rigidbody.position + m_targetDirection * (m_targetSpeed * deltaTime * timeScale);
